...
#define min(x,y)    ((x) < (y)? (x) : (y))
  ...
  int c1, c3, c5;
#pragma acc data copyin(A167433664, A3075694624, A3075403808, A167442400, A167452448, A167452800, A3075112992, A167451776, A167452128, A167451488, A167451136, A167424928, A167416192) copy(A3075985440)
{
#pragma acc kernels
{
for (c1 = 0; c1 <= 31; c1++) {
